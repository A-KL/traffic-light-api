namespace System.Web.Http.Hosting
{
    ...
    public static class HttpPropertyKeys
    {
        ...
        /// <summary>
        /// Provides a key for the <see cref="T:System.Web.Http.Controllers.HttpActionDescriptor"/> associated with this request.
        /// </summary>
        public static readonly string HttpActionDescriptorKey = "MS_HttpActionDescriptor";
        /// <summary>
        /// Provides a key for the current <see cref="T:System.Threading.SynchronizationContext"/> stored in Properties(). If Current() is null then no context is stored.
        /// </summary>
        ...
        /// <summary>
        /// Provides a key for the <see cref="T:System.Web.Http.Dependencies.IDependencyScope"/> associated with this request.
        /// </summary>
        ...
        /// <summary>
        /// Provides a key for the <see cref="T:System.Web.Http.Controllers.HttpRequestContext"/> for this request.
        /// </summary>
        public static readonly string RequestContextKey = "MS_RequestContext";
        /// <summary>
        /// Provides a key for the <see cref="T:System.Guid"/> stored in <see cref="T:System.Net.Http.Properties"/>. This is the correlation ID for that request.
        /// </summary>
        ...
        /// <summary>
        /// Provides a key for the parsed query string stored in <see cref="T:System.Net.Http.Properties"/>.
        /// </summary>
